...
const TEST_USERS = [
  {
    email: requireEnv('E2E_TEST_USER_EMAIL', 'test_user@medical.com'),
  ...
  {
    email: requireEnv('E2E_TEST_PARTNER_EMAIL', 'test_partner@medical.com'),
  ...
  {
    email: requireEnv('E2E_TEST_ADMIN_EMAIL', 'test_admin@medical.com'),
