...
import { generateQRCodeDataURL } from '@shared/lib/utils/qrcode';
...
export function QRCodeDisplay({ 
  ...
  if (isLoading) {
    return (
      <div className={`flex justify-center items-center bg-zinc-900  p-8 ${className}`}>
  ...
  if (error) {
    return (
      <div className={`bg-red-950/50 border border-red-500  p-4 text-center ${className}`}>
