    ...
    >
      <div className="space-y-6">
        ...
        <div>
          ...
          {images.length === 0 ? (
            <div className="text-center py-12 text-zinc-400 border border-zinc-700 ">
            ...
            <div className="space-y-4">
              {images.map((image, index) => (
                <div
                  key={index}
                  className="bg-zinc-900 p-4  flex items-start gap-4"
                >
                  {/* Image Preview */}
                  <div className="relative w-24 h-24 bg-zinc-800  overflow-hidden shrink-0">
                    <Image
                      src={image.imageUrl}
                    ...
                    />
                    {image.isPrimary && (
                      <div className="top-1 right-1 absolute bg-primary px-2 py-1  text-xs font-semibold">
                        Primary
                      </div>
                    )}
                  </div>
