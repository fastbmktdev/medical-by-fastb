...
export function ContactForm({ onSubmit, className }: ContactFormProps = {}) {
  ...
  return (
    <form 
      ...
      className={`space-y-4 mx-auto max-w-md ${className || ''}`}
    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          disabled={isSubmitting}
          className="bg-white text-zinc-950 px-4 py-3 border border-gray-300  focus:outline-none focus:ring-2 focus:ring-red-500 w-full resize-none transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
