...
export function SocialLinksEditor() {
  ...
  if (isLoading) {
    return <div className="animate-pulse bg-zinc-900/50 h-32 " />;
  }
      ...
      {isEditing ? (
        <div className="space-y-4">
          ...
          {availablePlatforms.length > 0 && (
            <div className="flex gap-2 items-center p-4 bg-zinc-100/30  border border-zinc-700">
              <select
        ...
        <div className="space-y-2">
          {links.length > 0 ? (
            ...
            <div className="bg-zinc-100/50 p-4  text-center text-zinc-400">
