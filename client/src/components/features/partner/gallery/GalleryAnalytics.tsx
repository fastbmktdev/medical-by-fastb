...
export function GalleryAnalytics({ hospitalId }: GalleryAnalyticsProps) {
  ...
  const loadAnalytics = useCallback(async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/partner/gallery/analytics?hospital_id=${hospitalId}&limit=10`);
        ...
        <Card>
          <CardBody className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className=" bg-warning-100 p-3">
      ...
      <Card className="border-l-4 border-primary-500 bg-primary-50/50">
        <CardBody className="p-4">
          ...
          <ul className="space-y-1 text-sm text-primary-800">
            ...
            <li>• Share your hospital page on social media</li>
