...
import { SavedPaymentMethod } from '@shared/services/payment.service';
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex space-x-3">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 bg-zinc-600 hover:bg-zinc-500 px-4 py-2  font-medium transition-colors"
        ...
        <button
          ...
          className="flex-1 bg-red-600 hover:bg-red-600 px-4 py-2  font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
        >
          {isProcessing ? (
            <>
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {showAddButton && (
            <button
              ...
              className="flex items-center space-x-2 bg-red-600 hover:bg-red-600 px-4 py-2  font-medium transition-colors"
            >
      ...
      {methods.length === 0 ? (
        ...
        <div className="space-y-4">
          {methods.map((method) => (
            <div
              key={method.id}
              className={`bg-zinc-800  p-6 border-2 ${
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      {method.is_default && (
                        <span className="bg-red-500/20 text-red-400 px-2 py-1  text-xs font-medium">
                          เริ่มต้น
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {onSelectMethod && (
                    <button
                      ...
                      className="bg-red-600 hover:bg-red-600 px-4 py-2  text-sm font-medium transition-colors"
                    >
                      เลือก
                    </button>
                  )}
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-zinc-800  p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto relative">
            {/* Close Button */}
            <button
              onClick={() => {
