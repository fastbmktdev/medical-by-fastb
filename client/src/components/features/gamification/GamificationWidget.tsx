...
import { useGamification } from '@shared/lib/hooks/useGamification';
...
export default function GamificationWidget({ className = '' }: GamificationWidgetProps) {
  ...
  if (loading) {
    return (
      <div className={`bg-zinc-100/50 backdrop-blur-sm border border-zinc-800/50  shadow-md p-4 ${className}`}>
        <div className="animate-pulse">
          <div className="h-4 bg-zinc-800  w-1/2 mb-2"></div>
  ...
  return (
    <div className={`bg-linear-to-br from-blue-950/50 to-purple-950/50 backdrop-blur-sm border border-blue-700/30  shadow-md p-4 ${className}`}>
      ...
      <div className="mb-3">
        ...
        <div className="w-full bg-zinc-800  h-2">
          <div
            className="bg-linear-to-r from-blue-500 to-purple-500 h-2  transition-all duration-500"
