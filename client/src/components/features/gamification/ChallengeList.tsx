...
import { Challenge, ChallengeProgress } from '@shared/types/gamification.types';
import { 
  GamificationCard, 
            ...
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    <span className={`px-2 py-1  text-xs font-medium ${typeColorClass}`}>
              ...
              {!progress && (
                <button
                  ...
                  className="bg-blue-600 px-4 py-2  hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
