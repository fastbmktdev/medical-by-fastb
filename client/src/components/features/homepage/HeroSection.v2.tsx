...
const HERO_HEADINGS = {
  subheading: "Welcome to our medical platform",
  heading: `Empowering Your Health Journey<br /><span class="text-brand-primary">Seamless</span> Access`,
  description:
    "Your one-stop platform to discover and book leading hospitals, appointment tickets, and medical services across Thailand.",
};
...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Quality medical services",
  },
  {
    icon: BuildingOfficeIcon,
    text: "Nationwide",
    description: "Hospitals across Thailand",
  },
];
