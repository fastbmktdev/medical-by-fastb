...
const cardVariants = cva(
  ...
  " overflow-hidden transition-all focus:outline-none",
  {
    variants: {
      variant: {
        default: "bg-white text-zinc-950 border border-gray-300",
        elevated: "bg-white text-zinc-950 border border-gray-300 shadow-lg",
        outlined: "bg-transparent border-2 border-gray-300",
        ghost: "bg-white/50 text-zinc-950 border border-transparent",
      },
      padding: {
        none: "p-0",
        sm: "p-4",
...
export interface CardProps
  extends Omit<
      ...
      keyof InteractiveProps | keyof LayoutComponentProps
    >,
    InteractiveProps,
    LayoutComponentProps,
