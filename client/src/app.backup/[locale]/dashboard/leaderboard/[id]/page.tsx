...
import { LeaderboardData, LeaderboardEntry } from '@shared/types/gamification.types';
...
export default function LeaderboardPage() {
  ...
  const getScoreLabel = (type: string) => {
    switch (type) {
      ...
      case 'appointments': return 'การจอง';
    ...
    <div className="min-h-screen bg-zinc-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {leaderboardData.user_rank && (
          <div className="mb-6 bg-blue-950/50 border border-blue-700/50  p-4">
        ...
        {/* Leaderboard Table */}
        <div className="bg-zinc-100/50 backdrop-blur-sm border border-zinc-800/50  overflow-hidden">
