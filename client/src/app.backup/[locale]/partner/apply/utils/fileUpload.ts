...
import { validateFileClient, sanitizeFilename } from '@shared/lib/utils/file-validation';
...
/**
 * Upload hospital images to Supabase Storage
...
export const uploadImages = async (
  ...
  for (const file of files) {
    try {
      ...
      // Upload to Supabase Storage bucket 'hospital-images'
