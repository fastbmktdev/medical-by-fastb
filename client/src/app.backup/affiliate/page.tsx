        ...
        <div className="container mx-auto px-4 py-16 relative z-10 flex flex-col items-center justify-center">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-zinc-300 text-xl mb-8">
              แนะนำเพื่อนเข้าร่วมแพลตฟอร์มการแพทย์และรับแต้มสะสม พร้อมสิทธิพิเศษมากมาย
            </p>
            <Button 
              color="primary" 
              size="lg"
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-80 lg:shrink-0">
            <div className="lg:sticky lg:top-24">
              <div className="bg-zinc-800/60 backdrop-blur-sm border border-zinc-700/50  p-6">
          ...
          <div className="flex-1 min-w-0">
            <Tabs 
              ...
              classNames={{
                tabList: "bg-zinc-800/60 border-zinc-700/50 backdrop-blur-sm  p-1",
            ...
            <Card className="bg-zinc-800/60 border-zinc-700/50 backdrop-blur-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300">
                  ...
                  <CardBody className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      {[
                        ...
                        <div key={step} className="text-center p-3 bg-zinc-700/30 ">
                          <div className={`w-8 h-8 ${color}  flex items-center justify-center text-white font-bold text-sm mx-auto mb-2 shadow-lg`}>
                            {step}
                          </div>
                    ...
                    <div className="bg-linear-to-br from-zinc-700/50 to-zinc-800/50 p-3  border border-zinc-600/50">
              ...
              <CardBody className="p-0">
                {referralHistory.length > 0 ? (
                  ...
                  <div className="text-center py-8 px-4">
                    <div className="w-12 h-12 bg-zinc-700/50  flex items-center justify-center mx-auto mb-3">
              ...
              <Card className="bg-zinc-800/60 border-zinc-700/50 backdrop-blur-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300">
                ...
                <CardBody className="space-y-4">
                  ...
                  {/* Tips Section */}
                  <div className="bg-linear-to-br from-purple-500/20 to-pink-500/20 p-3  border border-purple-500/30">
                    <h3 className="font-semibold mb-2 text-white flex items-center gap-2 text-sm">
                      <span>💡</span>
                      เคล็ดลับ Affiliate
                    </h3>
                  ...
                  {/* Motivation Box */}
                  <div className="bg-linear-to-br from-red-500/20 to-orange-500/20 p-3  border border-red-500/30">
