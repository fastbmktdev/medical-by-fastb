          ...
          <div>
            ...
            <div className="relative group">
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                className="absolute top-1/2 -translate-y-1/2 right-4 text-zinc-950 hover:text-zinc-950 p-1"
              >
                {showPassword ? (
          ...
          <div className="bg-white border border-gray-300  shadow-2xl max-w-md w-full p-8">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full bg-zinc-800/50 border border-gray-300  px-4 py-3 text-center text-2xl font-mono tracking-widest focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/70"
                placeholder="000000"
              />
            </div>
