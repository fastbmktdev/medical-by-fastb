/**
 * Products API Dynamic Routes - Proxy to Express Server
 * 
 * This route handles dynamic product routes like:
 * - /api/products/[id]
...
async function proxyRequest(
  ...
  try {
    ...
    const path = `/api/products/${pathSegments.join('/')}`;
    ...
    console.error('Error proxying request to API server:', error);
...
/**
 * Handle all HTTP methods for dynamic product routes
 */
