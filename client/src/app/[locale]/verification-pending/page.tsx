      ...
      <div className="space-y-6 pl-4">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="w-24 h-24 bg-green-600/20  flex items-center justify-center">
      ...
      fallback={
        ...
        >
          <div className="flex justify-center items-center py-12">
            <div className="animate-spin  h-12 w-12 border-t-2 border-b-2 border-red-500"></div>
          </div>
        </AuthLayout>
      }
    >
