                  ...
                  <TableRow key={category.id}>
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-semibold">{category.nameThai}</p>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, nameThai: value })
            }
          ...
          <Input
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, nameEnglish: value })
            }
        ...
        <Input
          ...
          onValueChange={(value) =>
            setFormData({ ...formData, displayOrder: parseInt(value) || 0 })
          }
          min="0"
        />
      </div>
