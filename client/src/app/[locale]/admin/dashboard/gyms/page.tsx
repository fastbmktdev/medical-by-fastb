...
function AdminHospitalsContent() {
  ...
  const paginatedHospitals = filteredHospitals.slice(pagination.startIndex, pagination.endIndex);
  ...
  const handleEditWithClose = async (hospitalId: string, data: Partial<hospital>) => {
            ...
            <ResponsiveTable
              ...
              columns={[
                ...
                },
                {
                  ...
                  label: 'ผู้ติดต่อ',
                  render: (hospital) => (
                    <span className="text-default-400">{hospital.contact_name}</span>
                  ),
                  showOnMobile: true,
                ...
                },
                {
                  ...
                  label: 'โทรศัพท์',
                  render: (hospital) => (
                    <span className="font-mono text-default-400 text-sm">{hospital.phone}</span>
                  ),
                  showOnMobile: false,
                ...
                },
                {
                  ...
                  label: 'สถานที่',
                  render: (hospital) => (
                    <span className="text-default-400">{hospital.location}</span>
                  ),
                  showOnMobile: false,
                ...
                },
                {
                  ...
                  render: (hospital) => (
                    <span className="text-default-400">
                      {hospital.created_at ? new Date(hospital.created_at).toLocaleDateString('th-TH') : '-'}
                    </span>
                  ),
                  showOnMobile: false,
                  exportFormat: (hospital) => hospital.created_at ? new Date(hospital.created_at).toLocaleDateString('th-TH') : '-',
                },
                {
                  key: 'actions',
                  label: 'การกระทำ',
