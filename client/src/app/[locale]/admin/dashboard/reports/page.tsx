...
function AdminReportsContent() {
  ...
  const reports: Array<{
    ...
    },
    {
      ...
      description: 'ข้อมูลโรงพยาบาลทั้งหมดในระบบ',
              ...
              <CardBody>
                <div className="flex gap-2">
                  <Button
                    ...
                    startContent={
                      isExportingPDF ? (
                        <div className="border-2 border-white border-t-transparent  w-4 h-4 animate-spin"></div>
                      ) : (
                  ...
                  <Button
                    ...
                    startContent={
                      isExportingCSV ? (
                        <div className="border-2 border-current border-t-transparent  w-4 h-4 animate-spin"></div>
                      ) : (
                        <ArrowDownTrayIcon className="w-4 h-4" />
                      )
                    }
