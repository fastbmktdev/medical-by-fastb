...
function AdminModerationContent() {
  ...
  function getContentUrl(contentType: string, contentId: string, slug?: string): string | null {
    const urlMap: Record<string, (id: string, slug?: string) => string> = {
      ...
      hospital: (id, slug) => slug ? `/hospitals/${slug}` : `/hospitals/${id}`,
          ...
          <ModalBody>
            {selectedFlag && (
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white text-zinc-950  border border-gray-300">
                  ...
                  {isLoadingPreview ? (
                    <div className="flex items-center justify-center py-4">
                      <div className="border-2 border-zinc-600 border-t-transparent  w-6 h-6 animate-spin"></div>
                    </div>
                  ) : contentPreview ? (
