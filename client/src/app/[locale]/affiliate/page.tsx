...
export default function AffiliatePage() {
    ...
    try {
      ...
      if (referrals) {
        ...
        setStats({
          ...
          conversionRate:
            totalReferrals > 0 ? Math.round((totalReferrals / 10) * 100) : 0,
        });
      }
    } catch (error) {
  ...
  const shareOnSocial = (platform: string) => {
    const message = `🥊 เข้าร่วมแพลตฟอร์มการแพทย์กับฉัน! ใช้โค้ด ${affiliateCode} เพื่อรับสิทธิพิเศษ! ${affiliateLink}`;
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-white text-zinc-950 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-red-500/10  blur-3xl animate-pulse"></div>
        ...
        <div className="container mx-auto px-4 py-16 relative z-10 flex flex-col items-center justify-center">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-zinc-700 text-xl mb-8">
              แนะนำเพื่อนเข้าร่วมแพลตฟอร์มการแพทย์และรับแต้มสะสม
  ...
  const StatCard = ({
    ...
    <Card className="bg-white text-zinc-950 border-zinc-200 hover:border-zinc-300 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/10 group">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            <Tabs
              ...
              classNames={{
                tabList: "bg-white border-zinc-200  p-1",
                tab: "text-zinc-500 data-[selected=true]:text-zinc-950 data-[selected=true]:bg-zinc-100 data-[selected=true]:border-zinc-300",
                panel: "pt-4",
              }}
            >
              {/* Tab 1: Overview */}
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    <StatCard
                      icon={
                        <UserPlusIcon className="w-8 h-8 text-blue-500 mx-auto" />
                      }
                    ...
                    <StatCard
                      icon={
                        <FireIcon className="w-8 h-8 text-orange-500 mx-auto" />
                      }
                    ...
                    <StatCard
                      icon={
                        <GiftIcon className="w-8 h-8 text-purple-500 mx-auto" />
                      }
                  ...
                  <Card className="bg-white text-zinc-950 border-zinc-200 hover:border-zinc-300 transition-all duration-300">
                    ...
                    <CardBody className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={label}>
                            <label className="text-zinc-700 text-xs mb-2 flex items-center gap-2">
                              <span>{icon}</span>
                              {label}
                            </label>
                            <div className="flex gap-2">
                              <Input
                                ...
                                size="sm"
                                classNames={{
                                  input: "bg-zinc-100 text-zinc-950 text-xs",
                                  inputWrapper:
                                    "border-zinc-300 hover:border-zinc-500 h-9",
                                }}
                              />
                      ...
                      <Divider className="my-3 bg-zinc-200" />

                      <div>
                        <p className="text-zinc-700 text-xs mb-3 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      {[
                        ...
                        },
                        {
                          step: 2,
                          title: "เพื่อนสมัคร",
                          desc: "เพื่อนใช้ลิงก์สมัครสมาชิก",
                          color: "bg-green-500",
                          icon: "👥",
                        },
                        {
                        ...
                        >
                          ...
                          <p className="text-zinc-700 text-xs">{desc}</p>
                        </div>
                      ))}
                    </div>

                    <div className="bg-linear-to-br from-zinc-50 to-zinc-100 p-3  border border-zinc-200">
                      <h3 className="font-semibold mb-2 text-zinc-950 flex items-center gap-2 text-sm">
                        <span>🎁</span>
                        สิทธิประโยชน์
                      </h3>
                      <ul className="text-zinc-700 text-xs space-y-1">
                        {[
                          "รับ 200 แต้มต่อการแนะนำ 1 คน",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="overflow-x-auto max-h-64 overflow-y-auto">
                          <Table
                            ...
                            classNames={{
                              ...
                              th: "bg-linear-to-br from-zinc-50 to-zinc-100 text-zinc-700 border-b border-zinc-200 text-xs px-2 py-2",
                              td: "border-b border-linear-to-br from-zinc-5 to-zinc-100 text-zinc-800 text-xs px-2 py-2",
                            }}
                          >
                            <TableHeader>
                              ...
                              {referralHistory.slice(0, 5).map((referral) => (
                                ...
                                >
                                  ...
                                  <TableCell className="text-right">
                                    <span className="text-green-500 font-semibold flex items-center justify-end gap-1 text-xs">
                  ...
                  <Card className="bg-white text-zinc-950 border-zinc-200 hover:border-zinc-300 transition-all duration-300">
                    ...
                    <CardBody className="space-y-4">
                      ...
                      {/* Tips Section */}
                      <div className="bg-linear-to-br from-purple-500/10 to-pink-500/10 p-3  border border-purple-100">
                        <h3 className="font-semibold mb-2 text-zinc-950 flex items-center gap-2 text-sm">
                          <span>💡</span>
                          เคล็ดลับ Affiliate
                        </h3>
                      ...
                      {/* Motivation Box */}
                      <div className="bg-linear-to-br from-red-500/10 to-orange-500/10 p-3  border border-red-100">
