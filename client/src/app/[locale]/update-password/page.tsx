    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-6 text-zinc-950 text-base">
            รหัสผ่านของคุณได้รับการอัปเดตเรียบร้อยแล้ว
            <br />
            กำลังนำคุณไปยังหน้าแดชบอร์ด...
          </p>
          <div className="bg-green-500/20 mb-6 p-4 border border-green-500 ">
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {message === 'password_reset_success' && (
          <div className="bg-green-500/20 p-4 border border-green-500 ">
            <div className="flex items-center gap-3">
        ...
        {/* Info Message */}
        <div className="bg-blue-500/20 p-4 border border-blue-500 ">
          ...
          >
            ...
            <input
              ...
              className={`w-full bg-white text-zinc-950 border ${
                errors.password ? "border-red-500" : "border-gray-300 hover:border-gray-400 group-hover:border-gray-400"
              }  px-4 py-2.5 pr-10 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent font-mono text-sm`}
              placeholder="••••••••"
        ...
        <div>
          ...
          >
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full bg-white text-zinc-950 border ${
                errors.confirmPassword ? "border-red-500" : "border-gray-300 hover:border-gray-400 group-hover:border-gray-400"
              }  px-4 py-3 pr-10 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent font-mono`}
              placeholder="••••••••"
              autoComplete="new-password"
            />
            <Button
