...
import { signInWithGoogle, signInWithFacebook } from '@shared/services/auth.service';
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-wide text-gray-600">หรือเข้าสู่ระบบด้วยอีเมล</span>
            <div className="flex-1 h-px bg-gray-300" />
          </div>
        </div>
            ...
            <input
              ...
              onBlur={handleBlur}
                  className={`w-full bg-white text-zinc-950 border ${
                    errors.identifier ? "border-red-500/70 shadow-red-500/20" : "border-gray-300 hover:border-gray-400"
          ...
          >
            ...
            <div className="relative group">
                <input
                  ...
                  onBlur={handleBlur}
                  className={`w-full bg-white text-zinc-950 border ${
                    errors.password ? "border-red-500/70 shadow-red-500/20" : "border-gray-300 hover:border-gray-400 group-hover:border-gray-400"
