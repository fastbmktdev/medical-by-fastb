      ...
      <div className="max-w-2xl w-full bg-white dark:bg-gray-800  shadow-xl p-8 md:p-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-zinc-950 font-semibold py-3 px-6  transition-colors duration-200"
          >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          ...
          {showDetails && (
            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-900  overflow-auto">
