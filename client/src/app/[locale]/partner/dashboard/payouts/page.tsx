...
import type { PartnerPayout, hospital } from '@shared/types/database.types';
...
function PartnerPayoutsContent() {
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: 'รายการจอง', href: '/partner/dashboard/appointments', icon: CalendarIcon },
