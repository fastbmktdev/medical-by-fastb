...
-- Created: 2025-10-24
-- Consolidates backup migrations: create_hospital_images_bucket.sql, create_bucket_only.sql, setup-storage.sql
...
-- Update existing hospital-images bucket with enhanced configuration
