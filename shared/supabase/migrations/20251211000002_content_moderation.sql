...
CREATE TABLE IF NOT EXISTS content_flags (
  ...
  -- Content reference
  content_type TEXT NOT NULL CHECK (content_type IN ('article', 'hospital', 'review', 'comment', 'product', 'event', 'user_profile', 'message')),
...
COMMENT ON COLUMN content_flags.content_type IS 'Type of content being flagged: article, hospital, review, comment, product, event, user_profile, message';
