...
export const AFFILIATE_COMMISSION_RATES_FALLBACK = {
  ...
  appointment: 10, // 10% commission on appointments
 ...
 */
import { roundToTwoDecimals } from '@shared/lib/utils/number-utils';

export function calculateCommissionAmount(
  conversionValue: number,
  commissionRate: number
): number {
  return roundToTwoDecimals((conversionValue * commissionRate) / 100); // Round to 2 decimal places
}
