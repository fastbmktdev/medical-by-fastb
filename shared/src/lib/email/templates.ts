      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f9fafb;">
        <div style="max-width: 600px; margin: 0 auto; background: white;">
          ...
          <div style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); padding: 30px; text-align: center;">
            <h1 style="color: white; margin: 0; font-size: 28px; font-weight: bold;">🥊 medical Platform</h1>
          </div>
          ...
          <div style="background: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; font-size: 14px; margin: 0 0 10px 0;">
              <strong>medical Platform</strong>
            </p>
  ...
  const content = `
    ...
    <div style="background: #f9fafb; border-radius: 8px; padding: 24px; margin: 24px 0; border-left: 4px solid #dc2626;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding: 8px 0; color: #6b7280;">โรงพยาบาล:</td>
          <td style="padding: 8px 0; color: #1f2937;">${hospitalName}</td>
        </tr>
        <tr>
    ...
    <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
      หากมีคำถามหรือต้องการยกเลิกการจอง กรุณาติดต่อเราที่ <a href="mailto:support@medical.com" style="color: #dc2626;">support@medical.com</a>
    </p>
  `;
...
export function generatePaymentReceiptHtml(data: {
  ...
  const content = `
    ...
    <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
      ใบเสร็จนี้สามารถใช้เป็นหลักฐานการชำระเงินได้ หากมีคำถามกรุณาติดต่อ <a href="mailto:support@medical.com" style="color: #dc2626;">support@medical.com</a>
    </p>
  `;
...
export function generateBookingReminderHtml(data: {
  ...
  const address = hospitalAddress || gymAddress;
  const phone = hospitalPhone || gymPhone;
  ...
  const content = `
    ...
    <div style="background: #fef3c7; border-radius: 8px; padding: 24px; margin: 24px 0; border-left: 4px solid #f59e0b;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding: 8px 0; color: #78350f;">โรงพยาบาล:</td>
          <td style="padding: 8px 0; color: #78350f;">${hospitalName}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding: 8px 0; color: #78350f;"><a href="tel:${phone}" style="color: #78350f;">${phone}</a></td>
        </tr>
        ` : ''}
      </table>
    </div>
    ...
    <div style="background: #dbeafe; border: 1px solid #3b82f6; border-radius: 8px; padding: 16px; margin: 24px 0;">
      ...
      <ul style="margin: 8px 0 0 0; padding-left: 20px; color: #1e40af; font-size: 14px;">
        ...
        ${phone ? `<li>หากมีคำถามกรุณาติดต่อโรงพยาบาลที่ ${phone}</li>` : ''}
      </ul>
    </div>
    ...
    <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
      หากต้องการยกเลิกหรือเปลี่ยนแปลงการจอง กรุณาติดต่อเราทันทีที่ <a href="mailto:support@medical.com" style="color: #dc2626;">support@medical.com</a>
    </p>
  `;
  ...
  const content = `
    ...
    <div style="background: #dbeafe; border: 1px solid #3b82f6; border-radius: 8px; padding: 16px; margin: 24px 0;">
      ...
      <ul style="margin: 8px 0 0 0; padding-left: 20px; color: #1e40af; font-size: 14px;">
        ...
        <li>หากมีคำถามกรุณาติดต่อเราที่ <a href="mailto:support@medical.com" style="color: #1e40af;">support@medical.com</a></li>
      </ul>
    </div>
...
export function generatePartnerApprovalHtml(data: {
  ...
  const { partnerName, hospitalName, approvalDate, dashboardUrl } = data;

  const content = `
    <h2 style="color: #059669; margin-top: 0; font-size: 24px;">🎉 ยินดีด้วย! การสมัครโรงพยาบาลของคุณได้รับการอนุมัติ</h2>
    
    <p style="font-size: 16px; color: #374151;">สวัสดี <strong>${partnerName}</strong></p>
    
    <p style="color: #1f2937;">เรามีข่าวดี! การสมัครโรงพยาบาล <strong>${hospitalName}</strong> ของคุณได้รับการอนุมัติแล้วเมื่อวันที่ ${formatThaiDate(approvalDate)}</p>
    ...
    <div style="background: #d1fae5; border-radius: 8px; padding: 24px; margin: 24px 0; border-left: 4px solid #059669;">
      ...
      <ol style="margin: 0; padding-left: 20px; color: #065f46; line-height: 2;">
        ...
        <li>เพิ่มแพ็คเกจและบริการต่างๆ ของโรงพยาบาล</li>
    ...
    <div style="background: #fef3c7; border: 1px solid #fbbf24; border-radius: 8px; padding: 16px; margin: 24px 0;">
      <p style="margin: 0; color: #92400e; font-size: 14px;">
        <strong>💡 เคล็ดลับ:</strong> เพิ่มแพ็คเกจและข้อมูลโรงพยาบาลให้ครบถ้วนจะช่วยให้ลูกค้าค้นพบคุณได้ง่ายขึ้น และเพิ่มโอกาสในการได้รับการจอง
      </p>
    </div>
    
    <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
      หากมีคำถามหรือต้องการความช่วยเหลือในการตั้งค่า กรุณาติดต่อทีมสนับสนุนที่ <a href="mailto:partners@medical.com" style="color: #dc2626;">partners@medical.com</a>
    </p>
  `;
...
export function generatePartnerRejectionHtml(data: {
  ...
  const content = `
    <h2 style="color: #dc2626; margin-top: 0; font-size: 24px;">ขออภัย: การสมัครโรงพยาบาลของคุณยังไม่ได้รับการอนุมัติ</h2>
    
    <p style="font-size: 16px; color: #374151;">สวัสดี <strong>${partnerName}</strong></p>
    
    <p style="color: #1f2937;">เราขอขอบคุณที่สนใจเข้าร่วมเป็น Partner กับเรา อย่างไรก็ตาม หลังจากการตรวจสอบแล้ว การสมัครโรงพยาบาล <strong>${hospitalName}</strong> ของคุณยังไม่ผ่านเกณฑ์การอนุมัติในครั้งนี้</p>
    ...
    <div style="background: #dbeafe; border: 1px solid #3b82f6; border-radius: 8px; padding: 16px; margin: 24px 0;">
      ...
      <ul style="margin: 8px 0 0 0; padding-left: 20px; color: #1e40af; font-size: 14px;">
        ...
        <li>อัพโหลดรูปภาพที่ชัดเจนของโรงพยาบาล</li>
...
export function generateWelcomeEmailHtml(data: { fullName: string }): string {
  ...
  const content = `
    <h2 style="color: #dc2626; margin-top: 0; font-size: 24px;">ยินดีต้อนรับสู่ medical Platform! 🥊</h2>
    
    <p style="font-size: 16px; color: #374151;">สวัสดี <strong>${fullName}</strong></p>
    
    <p style="color: #1f2937;">เราดีใจที่คุณมาร่วมเป็นส่วนหนึ่งของชุมชนการแพทย์ เริ่มต้นสำรวจแพลตฟอร์มของเรา:</p>
    
    <div style="background: #f9fafb; border-radius: 8px; padding: 24px; margin: 24px 0; border-left: 4px solid #dc2626;">
      <h3 style="color: #dc2626; margin-top: 0; font-size: 18px;">คุณสามารถทำอะไรได้บ้าง:</h3>
      
      <ul style="color: #1f2937; line-height: 1.8;">
        <li>🔍 ค้นหาโรงพยาบาลใกล้คุณ</li>
        <li>📅 จองคอร์สฝึกสอน</li>
        <li>📚 อ่านบทความและเทคนิคการแพทย์</li>
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://medical.com'}/hospitals" style="display: inline-block; background: #dc2626; color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
        เริ่มต้นสำรวจ
      </a>
    </div>
    
    <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
      หากมีคำถามหรือต้องการความช่วยเหลือ กรุณาติดต่อ <a href="mailto:support@medical.com" style="color: #dc2626;">support@medical.com</a>
    </p>
  `;
  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>© 2025 medical Platform. สงวนลิขสิทธิ์.</p>
