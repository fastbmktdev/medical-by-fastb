...
export const RATE_LIMITS: Record<string, RateLimitConfig> = {
  ...
  '/api/appointments': { window: 60, max: 10, message: 'Too many appointment requests. Please slow down.' },
  '/api/appointments/hospital': { window: 60, max: 10, message: 'Too many appointment requests. Please slow down.' },
