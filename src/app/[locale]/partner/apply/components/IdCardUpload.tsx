...
export const IdCardUpload = ({
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const { validateIdCardImage, addWatermarkToImage } = await import("@/lib/utils/image-watermark");
  ...
  return (
    <div className="bg-zinc-950 shadow-xl p-6 md:p-8 rounded-xl">
      ...
      {/* Information Box */}
      <div className="mb-6 p-4 border border-purple-500/30 bg-purple-500/10 rounded-lg">
      ...
      {!previewUrl ? (
        <div>
          <label className="flex flex-col items-center gap-3 bg-zinc-700 hover:bg-zinc-600 p-8 border border-zinc-600 border-dashed rounded-lg transition-colors cursor-pointer">
        ...
        <div className="space-y-4">
          {/* Preview */}
          <div className="relative bg-zinc-800 p-4 rounded-lg">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 p-4 bg-zinc-900/50 border border-green-500/30 rounded-lg">
            ...
            <button
              ...
              className="flex items-center gap-2 mt-4 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-500 rounded-lg text-red-400 transition-colors"
            >
      ...
      {/* Warning */}
      <div className="mt-6 p-3 border border-yellow-500/30 bg-yellow-500/10 rounded-lg">
