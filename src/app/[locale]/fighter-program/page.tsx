...
const FadeInUp: FC<AnimationComponentProps> = ({
  children,
  delay = 0,
  className = "",
}) => {
...
const StaggeredFadeIn: FC<{ children: ReactNode; className?: string }> = ({
  children,
  className = "",
}) => {
  const [isVisible, setIsVisible] = useState(false);
...
const FloatingCard: FC<{ children: ReactNode; className?: string }> = ({
  children,
  className = "",
}) => (
  <div
...
const FaqItem: FC<{ faq: { question: string; answer: string } }> = ({
  faq,
}) => {
...
const TiersSection: FC = () => (
  <section id="tiers" className="bg-zinc-950 py-16 relative overflow-hidden">
          ...
          <div className="mt-12 text-center">
            <div className="bg-transparent rounded-2xl p-8 border border-red-500/20">
              ...
              <p className="text-zinc-400 mb-6">
                เริ่มต้นเส้นทางสู่การเป็นแชมป์ด้วยการสมัครออนไลน์
              </p>
...
export default FighterProgramPage;
