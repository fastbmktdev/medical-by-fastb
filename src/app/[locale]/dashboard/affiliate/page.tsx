...
import { cn, showSuccessToast, showErrorToast } from "@/lib/utils";
...
const StatCard: React.FC<{
  ...
  <Card className="bg-zinc-800/60 border-zinc-700/50 hover:border-zinc-600 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/10 group backdrop-blur-sm rounded-lg border">
