...
import { addEmailToQueue } from '@/lib/email/queue';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (existing) {
      ...
      if (!existing.is_active) {
        ...
        await addEmailToQueue({
          to: email,
          subject: 'ยินดีต้อนรับกลับสู่จดหมายข่าว MUAYTHAI! 🥊',
    ...
    await addEmailToQueue({
      to: email,
      subject: 'ยินดีต้อนรับสู่จดหมายข่าว MUAYTHAI! 🥊',
...
function generateWelcomeNewsletterEmailHtml(email: string, token: string): string {
  ...
  return `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>🥊 ยินดีต้อนรับสู่ MUAYTHAI Platform!</h1>
        </div>
        <div class="content">
          <p>สวัสดี!</p>
  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>ยินดีต้อนรับกลับสู่จดหมายข่าว MUAYTHAI!</p>
