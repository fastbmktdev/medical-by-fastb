...
export const POST = withAdminAuth(async (
  ...
  try {
    ...
    // Upload to Supabase Storage bucket 'article-media' (or 'gym-images' if article-media doesn't exist)
    // We'll use 'gym-images' bucket for now, but organize by folder
