...
- [ ] ส่ง notification เมื่อจองสำเร็จ
- [ ] ส่ง notification เมื่อชำระเงินสำเร็จ
- [ ] ส่ง notification เมื่อได้ Badge/Level Up
- [ ] ส่ง notification เตือนก่อนเข้าชั้นเรียน (1 วัน)
- [ ] ส่ง notification เมื่อ Partner ส่งข้อความ
- [ ] ส่ง notification สำหรับโปรโมชั่น
- [ ] เชื่อมต่อ Email Templates กับ Notification System (ส่งอีเมลพร้อมกับสร้าง notification)
- [ ] Real-time Notifications (WebSocket/Server-Sent Events) - แจ้งเตือนทันที
- [ ] Notification Preferences UI - หน้าให้ผู้ใช้จัดการการตั้งค่า (มีตารางแล้ว แต่ยังไม่มี UI)
...
- [ ] สร้าง Email Preferences ให้ User (มีตารางแล้ว แต่ยังไม่ได้เชื่อมต่อ)
